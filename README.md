...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cellfinder-napari-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15474&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cellfinder-napari-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cellfinder-napari` can be installed with:

```
conda install cellfinder-napari
```

It is possible to list all of the versions of `cellfinder-napari` available on your platform with:
